<section class="text-center pt-3 pb-2" style="background-color: white;">
<h1 class="fw-bold">TESTIMONIALS</h1>
  <p>Hear from our participants and explore our proud milestones in nurturing Naat research and excellence.</p>
</section>
...
<div id="testimonialCarousel" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <div class="testimonial-bg" style="padding-bottom: 120px;" >
        <div class="testimonial-content container">
          ...
          <div class="testimonial-author">
            <img src="<?php echo get_template_directory_uri(); ?>/images/review1.jpg" alt="Tabish Dehlvi">
            <h5 class="mt-2 mb-0">Tabish Dehlvi</h5>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="carousel-item">
      <div class="testimonial-bg">
        <div class="testimonial-content container">
          ...
          <div class="testimonial-author">
            <img src="<?php echo get_template_directory_uri(); ?>/images/review2.jpg" alt="Tabish Dehlvi">
            <h5 class="mt-2 mb-0">Tabish Dehlvi</h5>
          </div>
        </div>
      </div>
